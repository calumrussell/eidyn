{{ 
    config(
        ...
        post_hook = "alter table avg_rating_change_by_lichess_black_rating_range alter column opening set not null; alter table avg_rating_change_by_lichess_black_rating_range alter column black_rating_range set not null;",
    ) 
}}
select 
